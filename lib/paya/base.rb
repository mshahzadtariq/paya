module LocalHires
  module Paya
    class Base
      API_END_POINT = "https://demo.eftchecks.com/webservices/AuthGateway.asmx?WSDL"
      USER_NAME = "NationalCareerFairsCert"
      PASSWORD = "oCGH2SLZ$DCxDPTE"
...
xml
      ...
      def process_single_certification_check options={}, terminal_id=nil, identifier='R'
        ...
        response = @client.call(:process_single_certification_check, xml: xml)
